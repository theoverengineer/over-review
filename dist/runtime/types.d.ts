 ...
 */
export type AuthorAssociation = 'OWNER' | 'MEMBER' | 'COLLABORATOR' | 'CONTRIBUTOR' | 'FIRST_TIME_CONTRIBUTOR' | 'FIRST_TIMER' | 'MANNEQUIN' | 'NONE' | 'OUTSIDE_COLLABORATOR';
/**
 * PR action types.
 */
export type PrAction = 'opened' | 'edited' | 'closed' | 'reopened' | 'synchronize' | 'ready_for_review' | 'locked' | 'unlocked' | 'assigned' | 'unassigned' | 'review_requested' | 'review_request_removed' | 'milestoned' | 'demilestoned';
/**
